<?php
include_once "../../model/files/sale_apartment.php";
$m_class = new sale_apartment();
...
if (isset($_POST['submit']))
{
    ...
    header('location:'.BASE_URL.'file_add_sale_apartment/code/'.$new_code);
}
...
if (isset($_GET['del_code']))
{
    ...
    header("location:".BASE_URL."file_archive_sale_apartment");
}
