<?php
include_once "../../model/files/rent_commercial.php";
$m_class = new rent_commercial();
...
if (isset($_POST['submit']))
{
    ...
    header('location:'.BASE_URL.'file_add_rent_commercial/code/'.$new_code);
}
...
if (isset($_GET['del_code']))
{
    ...
    header("location:".BASE_URL."file_archive_rent_commercial");
}
