<?php
include_once "../../model/files/sale_commercial.php";
$m_class = new sale_commercial();
...
if (isset($_POST['submit']))
{
    ...
    header('location:'.BASE_URL.'file_add_sale_commercial/code/'.$new_code);
}
...
if (isset($_GET['del_code']))
{
    ...
    header("location:".BASE_URL."file_archive_sale_commercial");
}
