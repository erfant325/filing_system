                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($row['submit_fa_edit'])): ?>
                                ...
                                <br>
                            <?php endif; ?>
                            <a href="<?= BASE_URL ?>file_print_sale_apartment/<?= $row['id'] ?>"><i class="bx bx-printer"></i></a>
                            <br>
                            ...
                            <a href="<?= BASE_URL ?>controller/files/sale_apartment.php?arc_code=<?= $row['id'] ?>"
                            ...
                            <a href="<?= BASE_URL ?>controller/files/sale_apartment.php?del_code=<?= $row['id'] ?><?php if (!empty($row['pic_url1'])){ echo '&img_1='.$row['pic_url1'];} ?><?php if (!empty($row['pic_url2'])){ echo '&img_2='.$row['pic_url2'];} ?><?php if (!empty($row['pic_url3'])){ echo '&img_3='.$row['pic_url3'];} ?>"
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= BASE_URL ?>controller/sms_panel/sms_sender.php">
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="cus[db_table]" value="sale_apartment">
