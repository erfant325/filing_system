<?php
include_once "../../controller/files/sale_old.php";
global $m_class;
if (isset($_POST['filter_btn'])) {
    $query = 'SELECT * FROM file_sale_old WHERE ';
    $counter = 0;
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($row['submit_fa_edit'])): ?>
                                ...
                                <br>
                            <?php endif; ?>
                            <a href="<?= BASE_URL ?>file_print_sale_old/<?= $row['id'] ?>"><i class="bx bx-printer"></i></a>
                            <br>
                            <a href="<?= BASE_URL ?>file_edit_sale_old/<?= $row['id'] ?>"
                            ...
                            <a href="<?= BASE_URL ?>controller/files/sale_old.php?arc_code=<?= $row['id'] ?>"
                            ...
                            <a href="<?= BASE_URL ?>controller/files/sale_old.php?del_code=<?= $row['id'] ?><?php if (!empty($row['pic_url1'])){ echo '&img_1='.$row['pic_url1'];} ?><?php if (!empty($row['pic_url2'])){ echo '&img_2='.$row['pic_url2'];} ?><?php if (!empty($row['pic_url3'])){ echo '&img_3='.$row['pic_url3'];} ?>"
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?= BASE_URL ?>controller/sms_panel/sms_sender.php">
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="cus[db_table]" value="sale_old">
