        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">ویرایش فایل <?= $show_edit['id'] ?> اجاره اپارتمان</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data" action="<?= BASE_URL?>controller/files/rent_apartment.php">
                            <div class="form-body">
                                <div class="row">
