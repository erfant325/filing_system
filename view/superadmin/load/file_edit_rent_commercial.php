<?php
include_once "../../controller/files/rent_commercial.php";
global $m_class;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">ویرایش فایل <?= $show_edit['id'] ?> اجاره تجاری</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data" action="<?= BASE_URL?>controller/files/rent_commercial.php">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="number" id="first-name-column" class="form-control" placeholder="مبلغ پیش پرداخت" name="frmedit[pricemtr]" value="<?= $show_edit['price_pish'] ?>">
                                            <label for="first-name-column">مبلغ پیش پرداخت</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="number" id="first-name-column" class="form-control" placeholder="اجاره بها" name="frmedit[priceparking]" value="<?= $show_edit['price_rent'] ?>">
                                            <label for="first-name-column">اجاره بها</label>
                                        </div>
                                    </div>
