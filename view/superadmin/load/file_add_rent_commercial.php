        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">افزون فایل اجاره ملک تجاری</h4>
                </div>
                        ...
                        <form class="form" method="post" enctype="multipart/form-data" action="<?= BASE_URL?>/controller/files/rent_commercial.php">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="number" id="first-name-column" class="form-control" placeholder="پیش پرداخت" name="frm[price_pish]">
                                            <label for="first-name-column">پیش پرداخت</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="number" id="first-name-column" class="form-control" placeholder="اجاره بها" name="frm[price_rent]">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit" name="submit" class="btn btn-primary mr-1 mb-1">ثبت</button>
